...
public class PlatoEntityMapper implements EntityMapper<PlatoEntity, Plato> {
    ...
    public Mono<PlatoEntity> map(Mono<Plato> o) {
        return o.map(plato -> PlatoEntity.builder()
                ...
                .possibleModifications(plato.getPossibleModifications() != null ? plato.getPossibleModifications().toArray(new String[0]) : new String[0])
    ...
    public Mono<Plato> unmap(Mono<PlatoEntity> o) {
        return o.map(entity -> Plato.builder()
                .id(entity.getId())
                .nombre(entity.getNombre())
                .description(entity.getDescription())
                .iconUrl(entity.getIconUrl())
                .tags(entity.getTags() != null ? Arrays.asList(entity.getTags()) : List.of())
                .possibleModifications(entity.getPossibleModifications() != null ? Arrays.asList(entity.getPossibleModifications()) : List.of())
